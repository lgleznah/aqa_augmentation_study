baselines = {
    ...
    'celeba': [
        ...
        'baseline_celeba_hat',
        'baseline_celeba_male',
        'baseline_celeba_necklace',
        'baseline_celeba_necktie',
...
low_intensity = {
    ...
    'celeba': [
        ...
        'one_techs_low_intensity_celeba_hat',
        'one_techs_low_intensity_celeba_male',
        'one_techs_low_intensity_celeba_necklace',
        'one_techs_low_intensity_celeba_necktie',
...
high_intensity = {
    ...
    'celeba': [
        ...
        'one_techs_high_intensity_celeba_hat',
        'one_techs_high_intensity_celeba_male',
        'one_techs_high_intensity_celeba_necklace',
        'one_techs_high_intensity_celeba_necktie',
